...
intervalTimes = [0.6, 0.5, 0.6, 1.0] # First solpe, anticrossingn plateau, second slope, final plateau in ns
totalPoints = 300

populations, tlistNano, eiValues = DM.detuningProtocolAlternative(intervalTimes, totalPoints)
